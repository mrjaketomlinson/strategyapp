...
urlpatterns = [
    ...
    path("accounts/event/all/", views.planning_event_all, name="planning_event_all"),
    path("accounts/event/create/", views.planning_event_create, name="planning_event_create"),
    path("accounts/event/<int:planning_event_id>/edit/", views.planning_event_edit, name="planning_event_edit"),
